...
def displaygraphs(meas_list):
    ...
    first_recording = datetime.datetime.strptime("11/17/2016 05:30:00", "%m/%d/%Y %H:%M:%S")
    for measurement in meas_list:
        with open(measurement, 'r') as csvfile:
    ...
    host.set_title("Measurement and Recording of Temperature, Pressure, Humidity")
